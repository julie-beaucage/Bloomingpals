...
@section('content')
    ...
    <div id="event_cntr">
        ...
        <div class="container">
            <div class="section">
                <div id="event_header">
                    <h1 class="event_name">Gérer les demandes pour {{ $meetup->name }}</h1>
                </div>
                @if ($meetup['description'] != '' && $meetup['description'] != null)
                <div class="section">
            ...
            <div class="request-list">
                @foreach($pendingRequests as $request)
                    <div class="request-item">
                        <p>{{ $request->meetup_name }} - {{ $request->user_request->first_name }} {{ $request->user_request->last_name }}</p>
