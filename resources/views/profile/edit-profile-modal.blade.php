<div class="custom-overlay" id="overlayProfile" style="display: none;">
    ...
    <div onclick="document.getElementById('image_profile').click()" class="image-clickable">
        <img id="imagePreview" class="modifImage" src="{{ Auth::user()->image_profil ? asset('storage/' . Auth::user()->image_profil) : asset('..\images\flower.png') }}" alt="Aperçu de l'image" />
...
<div class="mb-3 image-container">
    ...
    <input type="file" class="form-control" id="background_image" name="background_image" style="display: none;"
        onchange="previewImage(event, 'backgroundPreview')">
    <div onclick="document.getElementById('background_image').click()" class="image-clickable">
        <img id="backgroundPreview" class="modifImage" src="{{ Auth::user()->background_image ? asset('storage/' . Auth::user()->background_image) : asset('..\images\R.jpg') }}" alt="Aperçu de l'image" />
        <span class="overlay-text">Modifier image</span>
    </div>
</div>
